  ...
  <v-footer app>
    <div class="d-flex flex-column flex-md-row w-100 ">
      <div class="d-flex justify-center">
        <a class="text-decoration-none text-h5 mx-5 align-content-center text-white" href="mailto:luvfitnesscz@gmail.com"
          target="_blank">
      ...
      <div class="text-caption text-disabled text-center align-content-center ms-md-auto" >
        <span class="me-5">

          IČO: 09687076
        </span>
        &copy; 2025-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Miroslav Vaněk</span>
      </div>
    </div>
  </v-footer>
</template>
